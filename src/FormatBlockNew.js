...
const FormatBlockNew = {
    ...
    setSubmenu: function (core) {
        ...
        for (let i = 0, len = formatList.length, format, tagName, command, name, h, attrs, className; i < len; i++) {
            ...
            list += '<li   >' +
                '<button tabindex="0" type="button"  class="se-btn-list" data-command="' + command + '" data-value="' + tagName + '" data-class="' + className + '" title="' + name + '">' +

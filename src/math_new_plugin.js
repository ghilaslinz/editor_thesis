import dialog from 'suneditor/src/plugins/modules/dialog.js';
      ...
      '<form>' +
          ...
          '<div class="se-dialog-body">' +
              '<div class="se-dialog-form">' +
                  '<label>' + lang.dialogBox.mathBox.inputLabel + ' (<a href="https://katex.org/docs/supported.html" target="_blank">X</a>MathJax</label>' +
  ...
  managedTags: function () {
      return {
          ...
          method: function (element) {
              ...
              element.innerHTML = dom.querySelector('.MathJax').innerHTML;
          }
      };
  },

  _renderer: function (exp) {
      const MathJax = this.context.option.MathJax;
//      return MathJax.src.renderToString(exp, MathJax.options);
return MathJax.src.Translate(exp, MathJax.options)
;
  },
  ...
  submit: function (e) {
      ...
      const submitAction = function () {
          ...
          const katexEl = contextMath.previewElement.querySelector('.MathJax');
          ...
          if (!this.context.dialog.updateModal) {
              ...
              const containerEl = this.util.getParentElement(contextMath._mathExp, '.MathJax');
